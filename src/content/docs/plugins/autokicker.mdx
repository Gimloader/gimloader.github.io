...
pluginDescription: Automatically kicks players from your lobby with a customizable set of rules
author: TheLazySquid
...
<ButtonInstall client:only="svelte" name="AutoKicker" url="https://raw.githubusercontent.com/Gimloader/client-plugins/main/plugins/AutoKicker/build/AutoKicker.js" />