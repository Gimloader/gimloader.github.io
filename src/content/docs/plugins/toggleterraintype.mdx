...
<ButtonInstall client:only="svelte" name="ToggleTerrainType" url="https://raw.githubusercontent.com/Gimloader/client-plugins/main/build/plugins/ToggleTerrainType.js" />