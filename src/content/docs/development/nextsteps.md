...
If you want to have your plugin included in the list of official Gimloader plugins, open a pull request to the [official plugins](https://github.com/Gimloader/client-plugins) repository. There are instructions in the README for adding a script.   